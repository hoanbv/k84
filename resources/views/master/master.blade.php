...
<head>
    ...
    {{-- asset lấy đường dẫn gốc/ cach 1 --}}
    <base href="{{asset('')}}">
    <!-- Thư viện vedor -->
   {{-- <link rel="stylesheet" href="{{asset('css/vendor.css')}}">  -cach 2--}} 
    ...
    <div class="main-wrapper">
        <div class="app" id="app">
            <header class="header">
                ...
                <marquee>
                    <h4>HỌC VIỆN CÔNG NGHỆ <b><span style="color: #FF9600">VIET</span><span
                                style="color: #050151">PRO</span></b> </h4>
                </marquee>
